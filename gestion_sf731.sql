...
(91, 8, 'ECOBANK_Gabon', 'photo', NULL, NULL, NULL, NULL, NULL),
(92, 8, 'ORABANK_Gabon', 'photo', NULL, NULL, NULL, NULL, NULL),
(93, 8, 'CITI', 'photo', NULL, NULL, NULL, NULL, NULL),
(94, 8, 'CSG', 'photo', NULL, NULL, NULL, NULL, NULL),
(95, 8, 'BGFI', 'photo', NULL, NULL, NULL, NULL, NULL),
(96, 20, 'Ecobank_Niger', 'photo', NULL, NULL, NULL, NULL, NULL);
...
(3, 15, 'PAPIER EN TETE DE LETTRE SECURISE', 16, 0, 'nonlivre', '2023-07-27', '10085', 6, 1, NULL),
(4, 37, 'CHEQUE DE 50 FEUILLES PETIT FORMAT ', 18, 0, 'nonlivre', '2023-07-13', '015', 6, 5, NULL),
(5, 74, 'LECTEUR SCANNER LS 150', 18, 0, 'livrenonpaye', '2023-07-12', '0600', 6, 5, NULL),
(6, 30, 'REPARATION CERCLEUSE TP 202 - MAINTENANCE GENERAL NETTOYAGES ET LUBRIFICATION -CHANGEMENT PIECES SPRING TA-032', 18, 0, 'livrenonpaye', '2023-07-07', '0567/CKY/23', 6, 5, NULL),
(7, 36, 'LECTEUR SCANNER LS 150', 18, 0, 'livrenonpaye', '2023-07-12', '0572/CKY/23', 6, 5, NULL),
(8, 75, 'ROULEAUX NON PERSONALISE', 18, 0, 'livrenonpaye', '2023-07-24', '0577/CKY/23', 6, 5, NULL),
(9, 74, 'GAUFFREUSE', 18, 0, 'livrenonpaye', '2023-08-11', '0585/CKY/23', 6, 5, NULL),
(10, 76, 'PAPIER ENTETE SECURISEE', 0, 0, 'nonlivre', '2023-08-07', '141/08/2023', 6, 5, NULL),
(11, 36, 'CHEQUES PETIT FORMAT DE 25 FEUILLETS - CHEQUES PETIT FORMAT DE 50 FEUILLES', 18, 0, 'nonlivre', '2023-06-20', '1906', 6, 5, NULL),
(12, 77, 'PAPIER ENTETE SECURISEE', 18, 0, 'nonlivre', '2023-08-01', '0581/CKY/23', 6, 5, NULL),
(13, 78, 'PAPIER ENTETE SECURISEE', 18, 0, 'nonlivre', '2023-08-01', '0613/CKY/23', 6, 5, NULL),
(14, 79, 'PAPIER ENTETE SECURISEE', 18, 0, 'nonlivre', '2023-08-07', '3765', 6, 5, NULL),
(15, 74, 'PAPIER ENTETE SECURISEE', 18, 0, 'nonlivre', '2023-08-08', '0619/CKY/23', 6, 5, NULL),
(16, 19, 'REPARATION MAGNER 100 AGENCE COLEA N° 1P267K0015 - MAINTENANCE GENERALE -REGLAGE DU CAPTEUR DES COMPTAGE -ET MISE EN MARCHE DE LA MACHINE - NETTOYAGE ET LUBRIFICATION ', 18, 0, 'livrenonpaye', '2023-08-17', '0589/CKY/23', 6, 5, NULL),
(17, 75, 'REPARATION CERCLEUSE TP 202 AGENCE MADINA N°B48925  -MAINTENANCE GENERALE NETTOYAGES ET GRAISSAGE  -CHANGEMENT PIECES ROUD BELT -HUILE MOTEUR', 18, 0, 'livrenonpaye', '2023-07-28', '0579/CKY/23', 6, 5, NULL),
(18, 80, 'ATRUM RESTAURATION AGENTS CAPITAL HUMAIN ', 16, 0, 'livrenonpaye', '2023-06-19', 'BDC230600200', 6, 1, NULL),
(19, 81, 'COMMANDE CONFECTION PIED DE PAGE ', 16, 0, 'nonlivre', '2023-08-15', 'MG-DF 0245/08/2023', 6, 1, NULL),
(20, 82, 'LECTEUR SCANNER DE CHEQUE ', 18, 0, 'nonlivre', '2023-02-28', '031/2023', 6, 3, NULL),
(21, 87, 'PAPIER ENTETE SECURISES - SUITE DE PAGE SECURISES  - PAPIER SECURISE : 95G / m - HOLOGRAMME 3D : LOGO VERSUS BANK - ENCRE UV - NUMERISATION EN UV INVISIBLE ', 18, 0, 'nonlivre', '2023-06-08', '6370', 6, 3, NULL),
(22, 84, 'FABRICATION CHEQUIERS DE 25', 0, 8000, 'nonlivre', '2023-08-01', 'WDZM2H6', 6, 1, NULL),
(23, 85, 'réparation Compteuse KISAN Newton A', 0, 0, 'livrenonpaye', '2023-07-31', '75/ABT/23', 6, 3, NULL),
(25, 51, 'CHEQUE DE BAO -COUVERTURE DE 25 CHEQUE 5000 -COUVERTURE DE 50 CHEQUE 3000 -COUVERTURE DE 100 CHEQUE 3000 - RIP_CODIGO DE IDENTITDADE BANCARIA 5000 - PEDIDO DE CHEQUE 5000 - RECIBO DE CHEQUE 5000', 19, 0, 'nonlivre', '2023-07-11', '001', 6, 3, NULL),
(26, 39, 'CHEQUES AVEC COPIE - CHEQUE SANS COPIE', 0, 0, 'nonlivre', '2023-05-19', '2023/130', 6, 8, NULL),
(27, 15, 'ORDRE DE TRANSFERT NATIONAL EQUITY BCDC DE 25 FEUILLES ', 16, 0, 'nonlivre', '2023-07-25', '10058', 6, 1, NULL),
(28, 40, 'LETTRE CHEQUE COLAS - Feuille à feuille ', 18, 0, 'livrenonpaye', '2023-06-09', '1564/2023', 6, 7, NULL),
(29, 88, 'PAPIER ENTETE SECURISEE', 16, 0, 'nonlivre', '2023-07-31', 'PR775510', 6, 1, NULL),
(30, 76, 'PAPIER ENTETE SECURISEE', 18, 0, 'livrenonpaye', '2023-08-21', '0591/CKY/23', 6, 5, NULL),
(31, 78, 'PAPIER ENTETE SECURISE', 18, 0, 'livrenonpaye', '2023-08-18', '0592/CKY/23', 6, 5, NULL),
(32, 90, 'PAPIER ENTETE SECURISEE', 18, 0, 'livrenonpaye', '2023-08-21', '0593/CKY/23', 6, 5, NULL),
(33, 79, 'PAPIER ENTETE SECURISEE', 18, 0, 'livrenonpaye', '2023-08-21', '0594/CKY/23', 6, 5, NULL),
(34, 89, '* PLANCHES - GRAND FORMAT - PETIT FORMAT - *COUVERTURE - GRAND FORMAT recto_verso - PETIT FORMAT recto_verso -*  INTERCALAIRES - GRAND FORMAT - PETIT FORMAT -* BANDS COLLANTES', 18, 0, 'livrenonpaye', '2023-08-21', '0595/CKY/23', 6, 5, NULL);
...
INSERT INTO `compte` (`id`, `devise_id`, `num`, `solde`, `banques_id`) VALUES
(1, 3, 'BGFI SECUREPRINT', 88466, 95),
(2, 3, 'BGFI', 0, 95);
...
INSERT INTO `operation` (`id`, `type`, `description`, `date`, `solde_r`, `solde_am`, `compte_id`, `user_id`, `montant`) VALUES
(1, 'entree', 'Solde reel', '2023-08-30 00:00:00', 0, 88466, 1, 7, 88466);
...
(11, 'Cameroun', 'flag-cameroon-64eeed71032be870641744.webp	', NULL, NULL, NULL, NULL, NULL),
...
(6, 'truvision_tn5@truvisionco.com', 'ROLE_SUPER_USER', '$2y$13$axy2/rBLl18x7wBack39V.W0sLNNf1ytxz/SEpNPNkPyJkaygF6I2', 'Bellil Seif', '41wggye-400x400-64ef090882e02102514364.jpg', NULL, 'approved', NULL, 1, NULL),
(7, 'truvision_tn6@truvisionco.com', 'ROLE_SUPER_USER', '$2y$13$wulTZt9LW1.56YDtBVgkYORCaPaHY81OQB4yCzehKIlhl/gHXmYui', 'ZAGHDOUDI HOUSSEM', 'images-64ef0826c7eff605474103.png', '', 'approved', NULL, 1, NULL),
...
(9, 'truvision_tn8@truvisionco.com', 'ROLE_USER', '$2y$13$g37ebwa9A5fh5hgFjxPPW.Y2jnscWGBJhk9eJfEhW55zTzGzEY3jm', 'abderahmen badreddine', 'tn8-telenica-1596-64ef0ad170256805877642.png', NULL, 'approved', NULL, 1, NULL),
(10, 'IT.INFO@TRUVISIONCO.COM', 'ROLE_SUPER_USER', '$2y$13$3snJA0iyivXSEBpMU4l.cuO6GVGEbcdphGMEoFhfbEVoB2mnZVdDS', 'IT IT', 'it-logo-2018-64ef098a40222554427661.jpg', NULL, 'approved', NULL, 1, NULL);
